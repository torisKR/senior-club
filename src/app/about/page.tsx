...
const faqEntries = [
  ...
  },
  {
    ...
    answer:
      "참가비는 모임마다 다릅니다. 무료 모임과 유료 모임 모두 있을 수 있으며, 신청 전에 각 모임 상세 화면에서 금액과 준비물을 확인할 수 있습니다. 유료 모임의 참가비는 현장에서 리더 안내에 따라 내며, 앱 안 Google Play 결제가 아닙니다.",
  },
  {
    question: "시니어클럽 플러스는 무엇인가요?",
    answer:
      "Android 앱의 배너 광고를 끄는 일회 구매입니다. 모임 찾기·신청·채팅은 플러스 없이도 이용할 수 있습니다. 웹에서는 구매할 수 없고, 이전에 산 내역은 같은 Google 계정으로 앱에서 복원할 수 있습니다.",
  },
  {
