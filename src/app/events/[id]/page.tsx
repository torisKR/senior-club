          ...
          <div className="min-w-0">
            <section className="panel p-6 sm:p-8" aria-labelledby="event-overview-heading">
              ...
              <dl className="mt-7 grid gap-3 sm:grid-cols-2">
                ...
                <div className="flex gap-3 rounded-xl bg-[var(--canvas)] p-4"><Banknote aria-hidden="true" className="mt-0.5 shrink-0 text-[var(--primary)]" size={25} /><div><dt className="text-sm font-black text-[var(--muted)]">참가비</dt><dd className="mt-0.5 font-black">{formatPrice(event.price)}</dd></div></div>
